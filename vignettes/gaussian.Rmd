...
We generate $n=500$ observations and $p=100$ predictors with block-wise correlation. Every 10 consecutive variables are highly correlated ($\rho=0.98$) within each block, while blocks are independent. Only 4 variables have nonzero effects, located in different correlation blocks.
